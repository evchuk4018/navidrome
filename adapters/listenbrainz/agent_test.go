			...
			Expect(resp).To(Equal([]agents.Song{
				{
					...
					Duration:         0,
					CandidateID:      "mbid:12f65dca-de8f-43fe-a65d-f12a02aaadf3",
					SimilarityScores: []agents.SimilarityScore{{Provider: "listenbrainz", Score: 124, NormalizedScore: 1}},
				},
				{
					ID:               "",
					...
					Duration:         0,
					CandidateID:      "mbid:80033c72-aa19-4ba8-9227-afb075fec46e",
					SimilarityScores: []agents.SimilarityScore{{Provider: "listenbrainz", Score: 65, NormalizedScore: 65.0 / 124.0}},
				},
			}))
		})
