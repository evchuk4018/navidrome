	...
	Describe("GetSimilarSongsByTrack", func() {
		...
		It("returns similar songs", func() {
			...
			Expect(agent.GetSimilarSongsByTrack(ctx, "123", "Just Can't Get Enough", "Depeche Mode", "", 5)).To(Equal([]agents.Song{
				{Name: "Dreaming of Me", MBID: "027b553e-7c74-3ed4-a95e-1d4fea51f174", Artists: []agents.Artist{{Name: "Depeche Mode", MBID: "8538e728-ca0b-4321-b7e5-cff6565dd4c0"}}, CandidateID: "mbid:027b553e-7c74-3ed4-a95e-1d4fea51f174", SimilarityScores: []agents.SimilarityScore{{Provider: "lastfm", Score: 1, NormalizedScore: 1}}},
				{Name: "Everything Counts", MBID: "5a5a3ca4-bdb8-4641-a674-9b54b9b319a6", Artists: []agents.Artist{{Name: "Depeche Mode", MBID: "8538e728-ca0b-4321-b7e5-cff6565dd4c0"}}, CandidateID: "mbid:5a5a3ca4-bdb8-4641-a674-9b54b9b319a6", SimilarityScores: []agents.SimilarityScore{{Provider: "lastfm", Score: 0.892602, NormalizedScore: 0.892602}}},
				{Name: "Don't You Want Me", MBID: "", Artists: []agents.Artist{{Name: "The Human League", MBID: "7adaabfb-acfb-47bc-8c7c-59471c2f0db8"}}, CandidateID: "title:don't you want me|artist:the human league", SimilarityScores: []agents.SimilarityScore{{Provider: "lastfm", Score: 0.491341, NormalizedScore: 0.491341}}},
				{Name: "Tainted Love", MBID: "", Artists: []agents.Artist{{Name: "Soft Cell", MBID: "7fb50287-029d-47cc-825a-235ca28024b2"}}, CandidateID: "title:tainted love|artist:soft cell", SimilarityScores: []agents.SimilarityScore{{Provider: "lastfm", Score: 0.454811, NormalizedScore: 0.454811}}},
				{Name: "Blue Monday", MBID: "727e84c6-1b56-31dd-a958-a5f46305cec0", Artists: []agents.Artist{{Name: "New Order", MBID: "f1106b17-dcbb-45f6-b938-199ccfab50cc"}}, CandidateID: "mbid:727e84c6-1b56-31dd-a958-a5f46305cec0", SimilarityScores: []agents.SimilarityScore{{Provider: "lastfm", Score: 0.381057, NormalizedScore: 0.381057}}},
			}))
			Expect(httpClient.RequestCount).To(Equal(1))
